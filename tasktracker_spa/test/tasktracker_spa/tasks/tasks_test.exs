defmodule TasktrackerSpa.TasksTest do
  ...
  describe "tasks" do
    ...
    @valid_attrs %{completed: true, desc: "some desc", minutes: 42, title: "some title"}
    @update_attrs %{completed: false, desc: "some updated desc", minutes: 43, title: "some updated title"}
    @invalid_attrs %{completed: nil, desc: nil, minutes: nil, title: nil}
